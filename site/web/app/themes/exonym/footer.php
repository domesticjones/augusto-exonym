...
?>
  ...
  <nav id="nav-responsive">
    <?php wp_nav_menu(array(
      'container' => 'ul',                        // enter '' to remove nav container
      'container_class' => 'nav-responsive-menu',	// class of container (should you choose to use it)
    ...
    <div class="address-footer">
      <?php ex_contact('address'); ?> (<a href="https://www.google.com/maps/place/<?php ex_contact('address'); ?>" target="_blank">map</a>)
    </div>
  </nav>
  <?php wp_footer(); ?>
</body>
